...
import {PasswordCriteria, CriteriaType} from "./PasswordCriteria";
...
export const PasswordInput: FC<PasswordInputProps> = ({ label, error, className, validationType, onChange,  ...inputProps}) => {
    ...
    return (
        <div className={cn(css.passwordInput, className)}>
            <TextInput
                ...
                {...inputProps}
            />
            <span className={cn(css.showPassword,
                { [css.error]: error}
                )}
